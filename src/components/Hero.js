                    ...
                    <div id='hero' className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        <div className="lg:w-1/2 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                            ...
                            <div className="text-xl font-semibold tracking-tight mb-5 text-gray-500">
                                Pioneering startup leveraging expertise in AI, Blockchain, Data engineering and Software development to deliver custom solutions and consulting services.</div>
                            <div className="mb-4 space-x-0 md:space-x-2 md:mb-8">
                                <Link to="/contact" className="text-zeniththemetext bg-zeniththemebg hover:bg-zeniththemebghover inline-flex items-center justify-center w-full px-6 py-3 my-4 text-lg shadow-xl rounded-2xl sm:w-auto sm:mb-0">
                                    Learn more
