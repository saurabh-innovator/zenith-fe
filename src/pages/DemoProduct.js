...
const DemoProduct = (props) => {
    ...
    useDocTitle('Zenith Techsphere - Demo our products')
                        ...
                        <div className="flex flex-col text-white">     
                            <div className="flex my-4 w-2/3 lg:w-3/4">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-gray-400">Survey No. 64, Building Number 9, 13th Floor, Madhapur, Hyderabad, Telangana 500081</p>
                                </div>
                            </div>
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className='mt-5'>
                                        ...
                                        <p className="text-gray-400">info@zenith-techsphere.com</p>
                                    </div>
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                ...
                                <a href="https://www.linkedin.com/company/zenith-techsphere/" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-blue-900  w-8 mx-1 text-center pt-1">
